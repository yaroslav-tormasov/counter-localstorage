        ...
        <div className={s.project}>
            {board === 1 ?
                <SetBoard value={value} setFunc={setFunc} disabledSetButton={disabledSetButton}
                          maximumValue={maximumValue} setMaximumValue={setMaximumValue} startValue={startValue}
                          setStartValue={setStartValue} activeMaxValue={activeMaxValue}
                          setActiveMaxValue={setActiveMaxValue} activeMinValue={activeMinValue}
                          setActiveMinValue={setActiveMinValue}
                          text={text} setText={setText}
                />
                :
                <div className='counter'>
                    <CountBoard value={value} maxValue={maximumValue} startValue={startValue} text={text}
                                setText={setText} activeMaxValue={activeMaxValue} activeMinValue={activeMinValue}
                    />
